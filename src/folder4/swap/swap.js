...
function Swap() {
  ...
  const swapTokens = async () => {
    ...
    try {
      ...
      await tokenContract.methods.approve(contractAddressAda, web3.utils.toWei("" + enterAmount))
        .send({
          from: actualAccount
        })
        .then(async (output) => {
        ...
        <div className="row">
          <div className="col">
            <h1 style={{
              ...
              <a href="https://pancakeswap.finance/swap?inputCurrency=0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47"
                target="_blank"
                style={{
                  color: "white",
                  padding: "5px",
          ...
          <div className="row">
            <div className="col-md-4 offset-md-4" id="msgcol">
              <p>
                Share your ADA Miner referral link, our contract pays you a 7% referral fee when anyone uses your link to hire miners:
                {/* <a
              ...
              <p>
                ...
                > Sustainability   </p>
                100% daily doesnt work, causing instant and massive inflation. ADA Miner pays a considerable 3% daily minimum, allowing users to rest easy knowing that their ADA has unlimited growth potential and a maximum, improbable risk of less than 3%. Simply Put, ADA in ADA Out
              </p>
              <p>
                <p style={{
                  fontWeight: "500",
                ...
                The ADA Miner contract is public, verified and can be viewed here on BSCScan.
              ...
              <p>
                ...
                ADA Miner pays 3% daily, according to the current mining efficiency rate. The mining efficiency rate rises and falls as you and other players hire miners, compound earnings and pocket ADA.
              </p>
              <p>
                The object of the game is hiring more miners, sooner and more often than other players. This in turn earns you more ADA faster. Hiring more miners using your daily ADA earnings will 3x your miners within 30 days or less.
              </p>
            </div>
          </div>
        </div>
