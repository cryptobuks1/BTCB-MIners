...
function Swap() {
  ...
  const swapTokens = async () => {
    ...
    try {
      ...
      await tokenContract.methods.approve(contractAddressXrp, web3.utils.toWei("" + enterAmount))
        .send({
          from: actualAccount
        })
        .then(async (output) => {
        ...
        <div className="row">
          <div className="col">
            <h1 style={{
              ...
              <a href="https://pancakeswap.finance/swap?inputCurrency=0x1d2f0da169ceb9fc7b3144628db156f3f6c60dbe"
                target="_blank"
                style={{
                  color: "white",
                  padding: "5px",
          ...
          <div className="row">
            <div className="col-md-4 offset-md-4" id="msgcol">
              <p>
                Share your XRP Miner referral link, our contract pays you a 7% referral fee when anyone uses your link to hire miners
                {/* <a
              ...
              <p>
                ...
                > Sustainability   </p>
                100% daily doesnt work, causing instant and massive inflation. XRP Miner pays a considerable 3% daily minimum, allowing users to rest easy knowing that their XRP has unlimited growth potential and a maximum, improbable risk of less than 3%. Simply Put, XRP in XRP Out
              ...
              <p>
                ...
                The XRP Miner contract is public, verified and can be viewed here on BSCScan.
              ...
              <p>
                ...
                XRP Miner pays 3% daily, according to the current mining efficiency rate. The mining efficiency rate rises and falls as you and other players hire miners, compound earnings and pocket XRP.

              </p>
              <p>
                The object of the game is hiring more miners, sooner and more often than other players. This in turn earns you more XRP faster. Hiring more miners using your daily XRP earnings will 3x your miners within 30 days or less.
              </p>
            </div>
          </div>
        </div>
