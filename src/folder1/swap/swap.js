...
function Swap() {
  ...
  const swapTokens = async () => {
    ...
    try {
      ...
      await tokenContract.methods.approve(contractAddressBsw, web3.utils.toWei("" + enterAmount))
        .send({
          from: actualAccount
        })
        .then(async (output) => {
        ...
        <div className="row">
          <div className="col">
            <h1 style={{
              ...
              <a href="https://exchange.biswap.org/#/swap?outputCurrency=0x965f527d9159dce6288a2219db51fc6eef120dd1"
                target="_blank"
                style={{
                  color: "white",
                  padding: "5px",
          ...
          <div className="row">
            <div className="col-md-4 offset-md-4" id="msgcol">
              <p>
                Share your BISWAP Miner referral link, our contract pays you a 7% referral fee when anyone uses your link to hire miners: https://biswapminer.co?ref=0xaf3537a993099778672c2BBf8A9ddfE478a378C7
                {/* <a
              ...
              <p>
                ...
                > Sustainability   </p>
                100% daily doesnt work, causing instant and massive inflation. BISWAP Miner pays a considerable 3% daily minimum, allowing users to rest easy knowing that their BISWAP has unlimited growth potential and a maximum, improbable risk of less than 3%. Simply Put, BISWAP in BISWAP Out
              </p>
              <p>
                <p style={{
                  fontWeight: "500",
                ...
                The BISWAP Miner contract is public, verified and can be viewed here on BSCScan.
              ...
              <p>
                ...
                BISWAP Miner pays 3% daily, according to the current mining efficiency rate. The mining efficiency rate rises and falls as you and other players hire miners, compound earnings and pocket BISWAP.

              </p>
              <p>
                The object of the game is hiring more miners, sooner and more often than other players. This in turn earns you more BISWAP faster. Hiring more miners using your daily BISWAP earnings will 3x your miners within 30 days or less.
              </p>
            </div>
          </div>
        </div>
